...
public class ForYouAdapter extends RecyclerView.Adapter<ForYouAdapter.ViewHolder>{
    ...
    public ForYouAdapter(Context mContext, ArrayList<Integer> imageView_top, ArrayList<Integer> imageView, ArrayList<String> textViewTitle, ArrayList<String> categories, ArrayList<String> textViewRating, ArrayList<String> appsSize) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.foryou_customlayout, parent, false);
